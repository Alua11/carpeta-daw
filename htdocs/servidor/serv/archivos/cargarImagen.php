...
if (isset($_POST['submit'])) { // comprobamos que se ha enviado el formulario
    ...
    if ($_FILES['foto']['name'] != "") { // El campo foto contiene una imagen...
        ...
        if ((($_FILES["foto"]["type"] == "image/gif")
            ...
            $directorio = dirname(__FILE__) . "/imagenes/"; // directorio de tu elección
        ...
        header("Location: " . $_SERVER['PHP_SELF'] . "?error=noImagen");
        exit;
    }
} // fin del submit
        ...
        <div style="margin-top: 25px; font-size: small;">
            ...
            while ($archivo = $directorio->read()) {
                ...
                if (
                    ...
                    echo "<a href='imagenes/" . $archivo . "' target='_blank'>" . $archivo . "</a> [ <a class='elimina' href='" . $_SERVER['PHP_SELF'] . "?eliminar=" . $archivo . "'>eliminar</a> ]<br>";
                }
            }
            $directorio->close();
            ?>
