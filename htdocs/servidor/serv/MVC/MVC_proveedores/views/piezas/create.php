...
<form action="index.php?accion=guardar&evento=crear&tabla=piezas" method="POST">
  <div class="form-group">
    <label for="pieza">ID Pieza </label>
  ...
  <div class="form-group">
    ...
    <input type="number" step=any min=0 pattern="^[0-9]+[.,]?[0-9]{0,2}$" class="form-control" id="preciovent" name="preciovent" placeholder="Introduce el Precio" value=<?= $_SESSION["datos"]["preciovent"] ?? ""; ?>>
    <?=
