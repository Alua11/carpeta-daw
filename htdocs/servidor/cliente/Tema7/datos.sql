...
INSERT INTO `localidad` (`nombre`, `descripcion_nombre`, `fecha_creacion`, `extension`, `nombre_provincia`) VALUES
...
INSERT INTO `provincia` (`nombre`, `descripcion_nombre`, `fecha_creacion`, `extension`) VALUES
...
INSERT INTO `vendedor` (`numvendedor`, `nombre`, `direccion`, `sueldo`, `fecha_nacimiento`, `cif`) VALUES
...
ALTER TABLE `localidad`
  ADD CONSTRAINT `caj_localidad` FOREIGN KEY (`nombre_provincia`) REFERENCES `provincia` (`nombre`) ON UPDATE CASCADE;

--  Claves ajena para la tabla `vender`
ALTER TABLE `vender`
  ADD CONSTRAINT `caj1_vender` FOREIGN KEY (`numvendedor`) REFERENCES `vendedor` (`numvendedor`) ON UPDATE CASCADE,
  ADD CONSTRAINT `caj2_vender` FOREIGN KEY (`nombre_provincia`) REFERENCES `provincia` (`nombre`) ON UPDATE CASCADE;
